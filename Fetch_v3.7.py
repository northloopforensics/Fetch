...
def make_IPaddress_Map():   #used to map ips
    ...
    if ip_geo_button == True:
        ...
        try:
            ...
            pass
        # except UnboundLocalError:
        #     print("unboundlocalerror in makeipaddressmap")
        #     pass
        try:
...
def make_map(in_df):       #bring in pandas dataframe
    ...
    if map_Type == "Points & Trails":
        ...
        if points_or_path == "Vapour Trail":
            ...
            # Define your travel history as a list of dictionaries with timestamped coordinates
            # travel_history = [
            #     {"coord": [[-122.4194,37.7749],[-118.2437,34.0522]], "time": ["2023-10-01T00:00:00","2023-10-02T00:00:00"]},
            #     {"coord": [[ -118.2437,34.0522], [-74.0060,40.7128]], "time": ["2023-10-02T00:00:00","2023-10-03T00:00:00"]},
            #     {"coord": [[-74.0060,40.7128], [-122.4194,37.7749]],"time": ["2023-10-03T00:00:00","2023-10-04T00:00:00"]},
            # ]
            ...
            for i in range(len(gdf) - 1):
                ...
                # row1_datetimeconv, row1_timestampstr = convert_to_datetime_and_string(row1[choose_datetime_column])
                # row2_datetimeconv, row2_timestampstr = convert_to_datetime_and_string(row2[choose_datetime_column])
